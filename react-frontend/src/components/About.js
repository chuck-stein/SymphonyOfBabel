    ...
    return (
        <div className='aboutParagraph'>
            <p>
                ...
                will just sound like white noise. The beauty of the symphony is in its rare gems, which you can locate by
                searching using your microphone. Give it any sound and it will point you to the exact excerpt in the symphony
                where that sound occurs. That excerpt has been and always will be in the same place in the symphony. To prove
                it, copy its ID and share it with a friend, who can then find that same excerpt by pasting the ID in the
                "Browse" section. The audio you recorded isn't being stored anywhere. To store every excerpt would take
                more gigabytes than there are atoms in the universe, if every atom contained a universe-worth of atoms,
                and each of those atoms contained another universe, and so on, 700+ layers deep. But don't let that overwhelm
